...
<div class="login-box"> 
  <div class="panel panel-default">
	...
	xmlns:xlink="http://www.w3.org/1999/xlink">
	  ...
	  <?php if ($success) { ?>
	  <div class="alert alert-success" style="margin-bottom:10px;"><i class="fa fa-check-circle"></i> <?php echo $success; ?>
	  ...
	  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
		<div class="form-group">
		  <div class="input-group"><span class="input-group-addon"><i class="fa fa-user"></i></span>
			<input type="text" name="username" value="<?php echo $username; ?>" placeholder="<?php echo $entry_username; ?>" id="input-username" class="form-control input-lg" />
		  </div>
		  </br>
		  ...
		  <button type="submit" class="btn btn-nm btn-lg btn-block"><?php echo $button_login; ?></button>
		</div>
		<?php if ($forgotten) { ?>
