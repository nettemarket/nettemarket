...
class ControllerCommonDashboard extends Controller {
	public function index() {
		...
		$this->document->addScript('view/javascript/jquery/jvectormap/jquery-jvectormap-1.2.2.min.js');
		$this->document->addScript('view/javascript/jquery/jvectormap/jquery-jvectormap-world-mill-en.js');
		$this->document->addScript('view/javascript/jquery/jvectormap/jquery-jvectormap-turkey-tr-en.js'); 
		$this->document->addStyle('view/javascript/jquery/jvectormap/jquery-jvectormap-1.2.2.css');  
